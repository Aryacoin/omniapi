...
def decode(rawhex):
  ...
  print {'Sender':sender,'Reference':reference,'AYA':rawBTC, 'OMNI':rawOMNI,'inputs':inputs, 'error':error}
  return {'Sender':sender,'Reference':reference,'AYA':rawBTC, 'OMNI':rawOMNI,'inputs':inputs, 'error':error}
